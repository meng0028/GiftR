...
var app = {
    ...
    , savePerson: function () {
        ...
        // close the modal and do not save the array
    ...
    , cancelPerson: function () {
        ...
        // display the contents of index page
    ...
    , showIndexPage: function () {
            ...
            // show the people list in content div
            app.localStorageList.people.forEach(function (person) {
                ...
                // creater a chevron and give it event listener
    ...
    , saveGift: function () {
            ...
            // store the array in the local storafe
        ...
        // close the modal and do not save it
    ...
    , showGiftPage: function () {
        ...
        // create gift content div
        app.localStorageList.people[indexTemp].fullname;
